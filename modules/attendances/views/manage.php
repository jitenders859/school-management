<div class="w3-row">
    <div class="w3-container">
        ...
        <?= flashdata() ?>
        <p>
            <a href="<?= BASE_URL ?>attendances/create"><button class="w3-button w3-medium primary">
...
function refreshResults(searchPhrase) {
  ...
  var target_url = '<?= BASE_URL ?>api/count/attendances';
...
function noResults() {
  ...
  if (searchPhrase !== '') {
    ...
    var msg = 'There are currently no attendance records';
  }
...
function getRecords() {
  ...
  var target_url = '<?= BASE_URL ?>api/get/attendances';
  ...
  http.onload = function () {
    ...
    for (var i = 0; i < records.length; i++) {
      records[i];
      var recordUrl = '<?= BASE_URL ?>attendances/show/' + records[i]['id'];
