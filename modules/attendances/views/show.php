...
<div class="w3-row">
    <div class="w3-container">   
        ...
        <div class="w3-card-4">
            ...
            <div class="w3-container">
            <p>
                <a href="<?= BASE_URL ?>attendances/manage"><button class="w3-button w3-white w3-border"><i class="fa fa-list-alt"></i> VIEW ALL ATTENDANCES</button></a> 
                <a href="<?= BASE_URL ?>attendances/create/<?= $update_id ?>"><button class="w3-button w3-white w3-border"><i class="fa fa-pencil"></i> UPDATE DETAILS</button></a>
                ...
                <div id="delete-record-modal" class="w3-modal w3-center" style="padding-top: 7em;">
                    <div class="w3-modal-content w3-animate-right w3-card-4" style="width: 30%;">
                        ...
                        <div class="w3-container">
                            <?php 
                            echo form_open('attendances/submit_delete/'.$update_id);
                            ?>
                            <h5>Are you sure?</h5>
                            <p>You are about to delete an attendance record.  This cannot be undone. <br>
    ...
    <div class="w3-half w3-container">    
        <div class="w3-card-4 edit-block" style="margin-top: 1em;">
            ...
            <div class="edit-block-content">
              <div class="w3-border-bottom"><b>Trongate User ID:</b> <span class="w3-right w3-text-grey"><?= $trongate_user_id ?></span></div>
              <div class="w3-border-bottom"><b>School Id:</b> <span class="w3-right w3-text-grey"><?= $school_id ?></span></div>
              <div class="w3-border-bottom"><b>Created Time:</b> <span class="w3-right w3-text-grey"><?= $created_time ?></span></div>              
            </div>
        </div>
    </div>
    <div class="w3-half w3-container">    
