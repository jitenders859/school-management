<?php
class Live_stream extends Trongate {
...
function index() {
        ...
        //     FILTER_SANITIZE_URL);
        $redirect = 'http://localhost/sca/upload/callback/';
        ...
        $this->module('upload');
        $client->setAccessToken($this->upload->get_access_token());
        ...
        $data['view_module'] = 'live_stream';
        $data['view_file'] = 'live_stream';
