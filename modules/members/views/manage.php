<div class="w3-row">
    <div class="w3-container">
        ...
        <?= flashdata() ?>
        <p>
            <a href="<?= BASE_URL ?>members/create"><button class="w3-button w3-medium primary">
        ...
        <table class="w3-table results-tbl" id="results-tbl" style="margin-left: -2000em;">
            <thead>
                <tr class="primary">                    <th colspan="12">
                        <div class="table-top">
                            <div>   
...
function refreshResults(searchPhrase) {
  //update totalRows
    var params = {        
      ...
      'OR last_name LIKE': '%' + searchPhrase + '%',        
      'OR username LIKE': '%' + searchPhrase + '%',       
      'OR email LIKE': '%' + searchPhrase + '%'
    }

  var target_url = '<?= BASE_URL ?>api/count/members';
...
function noResults() {
  ...
  if (searchPhrase !== '') {
    ...
    var msg = 'There are currently no member records';
  }
...
function getRecords() {
  ...
  var target_url = '<?= BASE_URL ?>api/get/members';
