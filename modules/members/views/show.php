<div class="w3-row">
    <div class="w3-container">   
        ...
        <div class="w3-card-4">
            ...
            <div class="w3-container">
            <p>
                <a href="<?= BASE_URL ?>members/manage"><button class="w3-button w3-white w3-border"><i class="fa fa-list-alt"></i> VIEW ALL MEMBERS</button></a> 
                <a href="<?= BASE_URL ?>members/create/<?= $update_id ?>"><button class="w3-button w3-white w3-border"><i class="fa fa-pencil"></i> UPDATE DETAILS</button></a>

                <a href="<?= BASE_URL ?>messages/create/<?= $update_id ?>"><button class="w3-button w3-white w3-border"><i class="fa fa-envelope"></i> COMPOSE MESSAGE FOR CUSTOMER</button></a>
                ...
                <div id="delete-record-modal" class="w3-modal w3-center" style="padding-top: 7em;">
                    <div class="w3-modal-content w3-animate-right w3-card-4" style="width: 30%;">
                        ...
                        <div class="w3-container">
                            <?php 
                            echo form_open('members/submit_delete/'.$update_id);
                            ?>
                            <h5>Are you sure?</h5>
                            <p>You are about to delete a member record.  This cannot be undone. <br>
...
<div class="w3-third w3-container">    
        <div class="w3-card-4 edit-block" style="margin-top: 1em;">
            ...
            <div class="edit-block-content">
              ...
              <div class="w3-border-bottom"><b>Username:</b> <span class="w3-right w3-text-grey"><?= $username ?></span></div>
              <div class="w3-border-bottom"><b>Email:</b> <span class="w3-right w3-text-grey"><?= $email ?></span></div>              
            </div>
        </div>
    </div>
    
<?= Modules::run('associated_classes_and_members/_draw_association_info', $token) ?>
...
function populateAssociationInfo(relationshipModule) {
    ...
    var apiUrl = '<?= BASE_URL ?>' + relationshipModule + '/fetch/<?= $update_id ?>/members';
    var params = {
...
window.onload = function() {
    ...
    populateAssociationInfo('associated_classes_and_members');
