<div class="w3-row">
    <div class="w3-container">
        ...
        <?= flashdata() ?>
        <p>
            <a href="<?= BASE_URL ?>notess/create"><button class="w3-button w3-medium primary">
...
function refreshResults(searchPhrase) {
  ...
  var target_url = '<?= BASE_URL ?>api/count/notess';
...
function noResults() {
  ...
  if (searchPhrase !== '') {
    ...
    var msg = 'There are currently no notes records';
  }
...
function getRecords() {
  ...
  var target_url = '<?= BASE_URL ?>api/get/notess';
