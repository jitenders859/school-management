<div class="w3-row">
    <div class="w3-container">   
        ...
        <div class="w3-card-4">
            ...
            <div class="w3-container">
            <p>
                <a href="<?= BASE_URL ?>video_lessons/manage"><button class="w3-button w3-white w3-border"><i class="fa fa-list-alt"></i> VIEW ALL VIDEO LESSONS</button></a> 
                <a href="<?= BASE_URL ?>video_lessons/create/<?= $update_id ?>"><button class="w3-button w3-white w3-border"><i class="fa fa-pencil"></i> UPDATE DETAILS</button></a>
                ...
                <div id="delete-record-modal" class="w3-modal w3-center" style="padding-top: 7em;">
                    <div class="w3-modal-content w3-animate-right w3-card-4" style="width: 30%;">
                        ...
                        <div class="w3-container">
                            <?php 
                            echo form_open('video_lessons/submit_delete/'.$update_id);
                            ?>
                            <h5>Are you sure?</h5>
                            <p>You are about to delete a video lesson record.  This cannot be undone. <br>
...
<div class="w3-third w3-container">    
        <div class="w3-card-4 edit-block" style="margin-top: 1em;">
            ...
            <div class="edit-block-content">
              ...
              <div class="w3-border-bottom"><b>Video Path:</b> <span class="w3-text-grey"><br><?= nl2br($video_path) ?></span></div>
              <div class="w3-border-bottom"><b>Video Teaser:</b> <span class="w3-text-grey"><br><?= nl2br($video_teaser) ?></span></div>
              <div class="w3-border-bottom"><b>Synopsis:</b> <span class="w3-text-grey"><br><?= nl2br($synopsis) ?></span></div>
              <div class="w3-border-bottom"><b>Essentialometer:</b> <span class="w3-right w3-text-grey"><?= $essentialometer ?></span></div>
              <div class="w3-border-bottom"><b>Priority:</b> <span class="w3-right w3-text-grey"><?= $priority ?></span></div>
              <div class="w3-border-bottom"><b>Code Snippets:</b> <span class="w3-text-grey"><br><?= nl2br($code_snippets) ?></span></div>
...
<?= Modules::run('associated_video_lessons_and_video_resources/_draw_association_info', $token) ?>
...
function populateAssociationInfo(relationshipModule) {
    ...
    var apiUrl = '<?= BASE_URL ?>' + relationshipModule + '/fetch/<?= $update_id ?>/video_lessons';
    var params = {
...
function fetchAvailableRecords(results, relationshipModule) {
    ...
    var params = {
        callingModuleName: 'video_lessons',
        updateId: <?= $update_id ?>,
        selectedRecords,
...
window.onload = function() {
    ...
    populateAssociationInfo('associated_video_lessons_and_video_resources');
