<div class="w3-row">
    <div class="w3-container">   
        ...
        <div class="w3-card-4">
            ...
            <div class="w3-container">
            <p>
                <a href="<?= BASE_URL ?>video_resources/manage"><button class="w3-button w3-white w3-border"><i class="fa fa-list-alt"></i> VIEW ALL VIDEO RESOURCES</button></a> 
                <a href="<?= BASE_URL ?>video_resources/create/<?= $update_id ?>"><button class="w3-button w3-white w3-border"><i class="fa fa-pencil"></i> UPDATE DETAILS</button></a>
                ...
                <div id="delete-record-modal" class="w3-modal w3-center" style="padding-top: 7em;">
                    <div class="w3-modal-content w3-animate-right w3-card-4" style="width: 30%;">
                        ...
                        <div class="w3-container">
                            <?php 
                            echo form_open('video_resources/submit_delete/'.$update_id);
                            ?>
                            <h5>Are you sure?</h5>
                            <p>You are about to delete a video resource record.  This cannot be undone. <br>
...
<div class="w3-third w3-container">    
        <div class="w3-card-4 edit-block" style="margin-top: 1em;">
            ...
            <div class="edit-block-content">
              <div class="w3-border-bottom"><b>Button Title:</b> <span class="w3-right w3-text-grey"><?= $button_title ?></span></div>
              <div class="w3-border-bottom"><b>Target URL:</b> <span class="w3-right w3-text-grey"><?= $target_url ?></span></div>
              <div class="w3-border-bottom"><b>Downloadable:</b> <span class="w3-right w3-text-grey"><?= $downloadable ?></span></div>              
            </div>
        </div>
    </div>
...
function populateAssociationInfo(relationshipModule) {
    ...
    var apiUrl = '<?= BASE_URL ?>' + relationshipModule + '/fetch/<?= $update_id ?>/video_resources';
    var params = {
...
function fetchAvailableRecords(results, relationshipModule) {
    ...
    var params = {
        callingModuleName: 'video_resources',
        updateId: <?= $update_id ?>,
        selectedRecords,
