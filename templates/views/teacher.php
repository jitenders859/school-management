        ...
        <div class="navbar navbar-expand-md header-menu-one bg-light">
            <div class="nav-bar-header-one">
                <div class="header-logo">
                    <a href="index.html">
                        <img src="<?=BASE_URL ?>akkhor/img/logo.png" alt="logo">
                    </a>
                </div>
                ...
                <ul class="navbar-nav">
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-img">
                                <img src="<?=BASE_URL ?>akkhor/img/figure/admin.jpg" alt="Admin">
                            </div>
                        </a>
                            ...
                            <div class="item-content">
                                <div class="media">
                                    <div class="item-img bg-skyblue author-online">
                                        <img src="<?=BASE_URL ?>akkhor/img/figure/student11.png" alt="img">
                                    </div>
                                ...
                                <div class="media">
                                    <div class="item-img bg-yellow author-online">
                                        <img src="<?=BASE_URL ?>akkhor/img/figure/student12.png" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
                                ...
                                <div class="media">
                                    <div class="item-img bg-pink">
                                        <img src="<?=BASE_URL ?>akkhor/img/figure/student13.png" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
        ...
        <div class="dashboard-page-one">
            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
               <div class="mobile-sidebar-header d-md-none">
                    <div class="header-logo">
                        <a href="index.html"><img src="<?=BASE_URL ?>akkhor/<?=BASE_URL ?>akkhor/img/logo1.png" alt="logo"></a>
                    </div>
               </div>
            ...
            <div class="dashboard-content-one">
                ...
                <footer class="footer-wrap-layout1">
                    <div class="copyright">© Copyrights <a href="#">fluttec</a> 2021.</div>
                </footer>
